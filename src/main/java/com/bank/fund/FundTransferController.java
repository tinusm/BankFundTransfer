...
public class FundTransferController {
	...
	public @ResponseBody Long fundTransfer(@PathVariable Long id, @PathVariable("amount") Long amount,@PathVariable("thirdpartyaccountnumber") Long thirdpartyaccountnumber) {
		Long acc = null;
		Long bal = null;
